...
<head>
	...
	<script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
		integrity="sha384-+Z2m9zQV5l1Zl3e5v
		+Z2m9zQV5l1Zl3e5v" crossorigin="anonymous"></script>
...
<i class="align-middle" data-feather="shopping-bag"></i> <span class="align-middle">Create</span>
</a>
</li>
			  ...
			  <a class="nav-link dropdown-toggle d-none d-sm-inline-block" data-bs-toggle="dropdown">
				<span class="text-dark">{{ Auth::user()->name }}</span>
							...
							<div class="dropdown-menu dropdown-menu-end">
								...
								<div class="dropdown-divider"></div>
								@csrf
								<a href="{{route('logout')}}" action="submit" value="Logout" class="ms-3 btn btn-outline-warning"> Log out</a>
							</div>
						</li>
					</ul>
				</div>
